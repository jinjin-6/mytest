...
@Slf4j
@Component
public class GaoYouBLResetAlarmCommand implements GaoYouBLCmdHandler, InitializingBean {
    @Override
    public R exec(GaoYouBLAccessDevice device, CmdParam param) {
        ...
        byte[] command = GaoYouBLProtocolUtils.buildResetAlarmCommand(
    ...
    public void afterPropertiesSet() throws Exception {
        GaoYouBLCmdHandleManager.register(DoorAccessDeviceCmdCode.GAOYOU_RESET_ALARM, this);
    }
}
