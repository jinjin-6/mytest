...
@Slf4j
@Component
public class GaoYouBLSetControllerParaCommand implements GaoYouBLCmdHandler, InitializingBean {
    @Override
    public R exec(GaoYouBLAccessDevice device, CmdParam param) {
        ...
        if (param.getParams().get("delayTime") == null) {
        ...
        byte[] command = GaoYouBLProtocolUtils.buildSetControllerParaCommand(
    ...
    public void afterPropertiesSet() throws Exception {
        GaoYouBLCmdHandleManager.register(DoorAccessDeviceCmdCode.GAOYOU_SET_DOOR_DELAY, this);
    }
}
