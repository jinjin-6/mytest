...
@Slf4j
@Component
public class GaoYouResetAlarmCommand implements GaoYouCmdHandler, InitializingBean {
    @Override
    public R exec(GaoYouAccessDoor device, CmdParam param) {
        ...
        byte[] command = GaoYouBMProtocolUtils.buildResetAlarmCommand(
    ...
    public void afterPropertiesSet() throws Exception {
        GaoYouCmdHandleManager.register(DoorAccessDeviceCmdCode.GAOYOU_RESET_ALARM, this);
    }
}
